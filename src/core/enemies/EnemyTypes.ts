...
export const ENEMY_TYPES: Record<string, EnemyTemplate> = {
  grunt: {
    ...
    detectRange: 8, patrolRadius: 4, color: '#ff4444',
  },
  flier: {
    type: 'flier',
    ...
    detectRange: 10, patrolRadius: 3, color: '#ff8844',
  },
  turret: {
    type: 'turret',
    ...
    detectRange: 12, patrolRadius: 0, color: '#cc44cc',
  },
  boss: {
    type: 'boss',
    ...
    detectRange: 15, patrolRadius: 6, color: '#ff0000',
  },
};